...
class RedmineProjects(object):
    def __init__(self):
       ...
       self.json_data = {"issue":{"project_id":1, "tracker_id":1, "status_id":1, "priority_id":1, "subject": "Examplepost", "priority_id": 4}}
    ...
    def redmine_post(self):
        return requests.post(url=self.hg.format("issues.json"), data=self.json_data, auth=(self.redmine_login, self.redmine_password))
